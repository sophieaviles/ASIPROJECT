...
{
    public class InventoryValidationBehavior
    {
        ...
        public static readonly DependencyProperty IsValidationEnabledProperty =
          DependencyProperty.RegisterAttached("IsValidationEnabled", typeof(bool), typeof(InventoryValidationBehavior),
        ...
        public static void OnValidationSummaryPropertyChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                var behavior = new InventoryValidationBehavior(gridView, isEnabled);
            }
        }

        public InventoryValidationBehavior(RadGridView gridView, bool isEnabled)
        {
