    ...
    public static class StoredProcedureHelper
    {
            ...
            where TType : new()
        {
            ...
            if (piList == null)
            {
                ...
                piList = props.ToDictionary(prop => prop.Name.ToLower());
            }
        ...
        {
            if (reader.IsClosed)
                throw new InvalidOperationException("Error en la ejecución del procedimiento");
            ...
            for (var index = 0; index < reader.FieldCount; index++)
            {
                ...
                if (!piList.ContainsKey(name)) continue;
