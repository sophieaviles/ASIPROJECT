...
{
    public class OWTQ_TransferRequestMap : EntityTypeConfiguration<OWTQ_TransferRequest>
    {
        public OWTQ_TransferRequestMap()
        {
            // Primary Key
            this.HasKey(t => t.IdTransferRequestL);
            ...
            this.Property(t => t.IdTransferRequestL)
            ...
            this.ToTable("OWTQ_TransferRequest");
